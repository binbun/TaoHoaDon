        ...
        ${items.map((item, index) => `
          <tr>
            ...
            <td class="col-price">
              ...
              ${item.discount > 0 ? `<div class="discount-badge" style="margin-top: 2px;">-${formatCurrency(item.discountAmount || (item.quantity * item.unitPrice * (item.discount / 100)))} (${item.discount}%)</div>` : ''}
            </td>
